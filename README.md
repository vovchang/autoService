...
Отражение приходов и расходов товаров с формированием текущих остатков.
...
Анализ взаиморасчетов с покупателями с отображением оборотов и текущего сальдо по контрагентам.
